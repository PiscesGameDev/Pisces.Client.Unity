...
namespace Pisces.Protocol
{
    ...
    public partial class IntValueList
    {
        ...
        public void ToList(List<int> result) =>
            CollectionConvertHelper.FillList(Values, result, i => i);
    }
    ...
    public partial class ByteValueList
    {
        ...
        public static ByteValueList From<T>(List<T> messages)
            where T : IMessage<T>
        {
        ...
        public void ToList<T>(List<T> result)
            where T : IMessage, new() =>
            CollectionConvertHelper.FillList(Values, result, ProtoSerializer.Deserialize<T>, true);
        ...
        public void ToList<T>(List<T> result, MessageParser<T> parser)
            where T : IMessage<T> =>
            CollectionConvertHelper.FillList(
                Values,
                result,
                bs => ProtoSerializer.Deserialize(bs, parser),
                true
            );
    ...
    public partial class IntKeyMap
    {
        ...
        public static IntKeyMap From<T>(Dictionary<int, T> dict)
            where T : IMessage<T>
        {
            var map = new IntKeyMap();
            CollectionConvertHelper.FillEntriesFromDictionary(
                dict,
                map.Entries,
        ...
        public void ToDictionary<T>(Dictionary<int, T> result)
            where T : IMessage, new() =>
            CollectionConvertHelper.FillDictionary(
                Entries,
                result,
                e => e.Key,
                e => ProtoSerializer.Deserialize<T>(e.Value)
            );
        ...
        /// <param name="result">用于接收结果的字典</param>
        /// <param name="parser">用于反序列化消息的解析器</param>
        public void ToDictionary<T>(Dictionary<int, T> result, MessageParser<T> parser)
            where T : IMessage<T> =>
            CollectionConvertHelper.FillDictionary(
                Entries,
                result,
                e => e.Key,
                e => ProtoSerializer.Deserialize(e.Value, parser)
            );
    }
    ...
    public partial class LongKeyMap
    {
        ...
        public static LongKeyMap From<T>(Dictionary<long, T> dict)
            where T : IMessage<T>
        {
        ...
        /// <typeparam name="T">实现 IMessage 接口且具有无参构造函数的消息类型</typeparam>
        /// <param name="result">用于接收结果的字典</param>
        public void ToDictionary<T>(Dictionary<long, T> result)
            where T : IMessage, new() =>
            CollectionConvertHelper.FillDictionary(
                Entries,
                result,
        ...
        /// <param name="result">用于接收结果的字典</param>
        /// <param name="parser">用于反序列化消息的解析器</param>
        public void ToDictionary<T>(Dictionary<long, T> result, MessageParser<T> parser)
            where T : IMessage<T> =>
            CollectionConvertHelper.FillDictionary(
                Entries,
                result,
    ...
    public partial class StringKeyMap
    {
        ...
        public static StringKeyMap From<T>(Dictionary<string, T> dict)
            where T : IMessage<T>
        {
        ...
        /// <typeparam name="T">实现 IMessage 接口且具有无参构造函数的消息类型</typeparam>
        /// <param name="result">用于接收结果的字典</param>
        public void ToDictionary<T>(Dictionary<string, T> result)
            where T : IMessage, new() =>
            CollectionConvertHelper.FillDictionary(
                Entries,
                result,
        ...
        /// <param name="result">用于接收结果的字典</param>
        /// <param name="parser">用于反序列化消息的解析器</param>
        public void ToDictionary<T>(Dictionary<string, T> result, MessageParser<T> parser)
            where T : IMessage<T> =>
            CollectionConvertHelper.FillDictionary(
                Entries,
                result,
    ...
    public partial class ByteValueMap
    {
        ...
        public static ByteValueMap From<T>(Dictionary<ByteString, T> dict)
            where T : IMessage<T>
        {
        ...
        /// <typeparam name="T">实现 IMessage 接口且具有无参构造函数的消息类型</typeparam>
        /// <param name="result">用于接收结果的字典</param>
        public void ToDictionary<T>(Dictionary<ByteString, T> result)
            where T : IMessage, new() =>
            CollectionConvertHelper.FillDictionary(
                Entries,
                result,
        ...
        /// <param name="result">用于接收结果的字典</param>
        /// <param name="parser">用于反序列化消息的解析器</param>
        public void ToDictionary<T>(Dictionary<ByteString, T> result, MessageParser<T> parser)
            where T : IMessage<T> =>
            CollectionConvertHelper.FillDictionary(
                Entries,
                result,
    ...
    public partial class Vector2
    {
        ...
        public static implicit operator UnityEngine.Vector2(Vector2 v) =>
            v != null ? new UnityEngine.Vector2(v.X, v.Y) : UnityEngine.Vector2.zero;
    }
    ...
    public partial class Vector3
    {
        ...
        public static implicit operator UnityEngine.Vector3(Vector3 v) =>
            v != null ? new UnityEngine.Vector3(v.X, v.Y, v.Z) : UnityEngine.Vector3.zero;
    }
    ...
    public partial class Vector3List
    {
        ...
        public void ToList(List<UnityEngine.Vector3> result) =>
            CollectionConvertHelper.FillList(Values, result, v => (UnityEngine.Vector3)v);
    ...
    public partial class Vector2Int
    {
        ...
        public static implicit operator UnityEngine.Vector2Int(Vector2Int v) =>
            v != null ? new UnityEngine.Vector2Int(v.X, v.Y) : UnityEngine.Vector2Int.zero;
    }
    ...
    public partial class Vector3Int
    {
        ...
        public static implicit operator UnityEngine.Vector3Int(Vector3Int v) =>
            v != null ? new UnityEngine.Vector3Int(v.X, v.Y, v.Z) : UnityEngine.Vector3Int.zero;
    }
    ...
    public partial class Vector2List
    {
        ...
        public void ToList(List<UnityEngine.Vector2> result) =>
            CollectionConvertHelper.FillList(Values, result, v => (UnityEngine.Vector2)v);
    ...
    public partial class Vector2IntList
    {
        ...
        public void ToList(List<UnityEngine.Vector2Int> result) =>
            CollectionConvertHelper.FillList(Values, result, v => (UnityEngine.Vector2Int)v);
    ...
    public partial class Vector3IntList
    {
        ...
        public void ToList(List<UnityEngine.Vector3Int> result) =>
            CollectionConvertHelper.FillList(Values, result, v => (UnityEngine.Vector3Int)v);
